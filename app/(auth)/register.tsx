...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Đăng ký nhưng không tự động login
      ...
      // Đăng ký thành công -> quay về màn Login
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: 'bold', marginBottom: 30, textAlign: 'center', fontFamily: Fonts.sans },
